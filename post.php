...
$query .="VALUES($the_post_id, '{$comment_author}', '{$comment_email}', '{$comment_content}', 'unapproved', now()) ";
    ...
    $update_comment_count = mysqli_query($connection, $query);
        ...
        echo "<script>alert('Fields of comment cannot be empty')</script>";
    }
...
<input type="email" name="comment_email" class="form-control" placeholder="Enter your email in abc@xyz format">
</div>
<div class="form-group">
