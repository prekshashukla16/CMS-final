...
<!--
    ...
    <?php 
      ...
      $query = "SELECT * FROM posts WHERE post_user_id = {$user_id} AND post_status = 'draft' ";
    ...
    $publish_post_count = mysqli_num_rows($select_all_publish_posts);
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Data', 'Count'],
            ...
            $element_count = [$post_count, $draft_post_count, $publish_post_count, $comment_count, $unapproved_comment_count, $user_count, $subscriber_user_count,$category_count];
